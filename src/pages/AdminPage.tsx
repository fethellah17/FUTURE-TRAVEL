  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-accent/20 px-4 py-3 flex items-center justify-between">
        ...
        <img src={logo} alt="FUTURE TRAVEL" className="h-10 w-auto" />
      ...
      `}>
        <div className="p-6 border-b border-accent/20">
          <Link to="/" className="flex flex-col items-center">
            <img src={logo} alt="FUTURE TRAVEL" className="h-16 w-auto mb-3" />
          </Link>
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4 relative">
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          <img src={logo} alt="FUTURE TRAVEL" className="h-20 sm:h-24 w-auto mx-auto mb-4" />
          <p className="text-sm text-muted-foreground">Administration</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1.5">Email</label>
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-input" placeholder="EX : futuretravel01@gmail.com" required />
          </div>
          <div>
