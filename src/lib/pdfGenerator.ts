...
export const generateMessagePDF = (message: Message) => {
  ...
  addText(doc, "ZAHRAT AL HOUDA", pageWidth / 2, 15, { align: "center" });
  ...
  addText(doc, "www.zahratalhouda.com - Votre partenaire de confiance pour vos voyages", pageWidth / 2, footerY, { align: "center" });
